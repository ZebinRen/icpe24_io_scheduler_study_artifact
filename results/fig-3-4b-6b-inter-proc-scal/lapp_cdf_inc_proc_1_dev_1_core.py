...
# settings
results_root = 'results_lapp_cdf_inc_proc_1_dev_1_core'
...
fig_name_prefix = 'lapp_cdf_inc_proc_1_dev_1_core'
...
if True:
    ...
    for cur_percentile_name, cur_percentile_value in zip(
        ...
        reset_color()
        fig_save_path = 'fig-6b-' + fig_name_prefix + '_heatmap_base_none_0_{}.pdf'.format(
            cur_percentile_name)
...
if True:
    ...
    for index, cur_num_proc in zip(range(len(num_processes)), num_processes):
        print('plot CDF')
        reset_color()
        fig_save_path = 'fig-3-' + fig_name_prefix + '_cdf_proc_{}.pdf'.format(
            cur_num_proc)
        ...
        if cur_num_proc == '1':
            ...
            plt.text(200, 0.8, 'BFQ: 84.8 $\mu$s', size=datalabel_size)
            ...
            plt.annotate('',
                         ...
                         xytext=(300, 0.8),
                         arrowprops=dict(arrowstyle='->', lw=5))
            plt.text(300, 0.9, 'None: 205.8 $\mu$s', size=datalabel_size)
            plt.text(300, 0.8, 'BFQ: 236.5 $\mu$s', size=datalabel_size)
            plt.text(300, 0.7, 'Kyber: 226.3 $\mu$s', size=datalabel_size)
            plt.text(300, 0.6, 'MQ-DL: 218.1 $\mu$s', size=datalabel_size)
            ...
            plt.annotate('',
                         ...
                         xytext=(500, 0.8),
                         arrowprops=dict(arrowstyle='->', lw=5))
            plt.text(500, 0.9, 'None: 419.8 $\mu$s', size=datalabel_size)
            plt.text(500, 0.8, 'BFQ: 485.4 $\mu$s', size=datalabel_size)
            plt.text(500, 0.7, 'Kyber: 456.7 $\mu$s', size=datalabel_size)
            plt.text(500, 0.6, 'MQ-DL: 448.5 $\mu$s', size=datalabel_size)
