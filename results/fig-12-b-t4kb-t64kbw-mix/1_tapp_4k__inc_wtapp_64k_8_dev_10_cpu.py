...
# settings
results_root = 'results_tapp_4k_inc_wtapp_64k_8_dev_10_cpu'
fig_dir = results_root
fio_results_dir = os.path.join(results_root, 'fio_output')
fig_name_prefix = 'tapp_4k_inc_wtapp_64k_8_dev_10_cpu'
    ...
    for cur_t_app_num in t_app_num:
        ...
        if cur_t_app_num != 0:
            for cur_t_index in range(1, cur_t_app_num + 1):
                ...
                cur_total_bandwidth += j_res['write:bw'] / 1024  # GB/s
